...
_TABLE_NOTE_LONG: dict[int, str] = {
    55: (
        ...
        "Slunce dobového juliánského roku (v polovině 17. stol. už jarní rovnodennost "
        "driftovala na ~11. března jul.), nýbrž <b>ideální rovnodennosti 21. března</b> — "
        "tj. je to <b>věčná (perpetuální) juliánská tabule</b> kalibrovaná „nicejsky“, jak měl "
        "juliánský kalendář původně fungovat, ne přepočítaná na dobový desetidenní drift. To je "
        "typický rys přejaté hotové tabule, nikoli čerstvého výpočtu na konkrétní rok.</p>"
        ...
        "refrakce, pro Prahu, v juliánském kalendáři kalibrovaném na rovnodennost 21. března. "
        "Náš přepis se s tímto modelem (pravé Slunce) shoduje na úrovni zaokrouhlení "
