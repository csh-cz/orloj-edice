...
_TABLE_NOTE_LONG: dict[int, str] = {
    55: (
        ...
        "perpetuálních tabulek „<i>Ortus et Occasus Solis, etiam Longitudo Diei et Noctis, pro "
        "singulis diebus, in horis et minutis, ad Elevationem Poli N graduum</i>“ — východ a "
        "západ Slunce a délka dne i noci pro každý den, v hodinách a minutách, počítané zvlášť "
        "pro každou výšku pólu (zeměpisnou šířku). Vycházely v efemeridách — např. <b>Andrea "
        "Argoli, Ephemerides 1641–1700</b> s tabulkou pro výšku pólu 1°–60° (pozoruhodně "
        "začínající právě r. 1641) — i samostatně pro konkrétní šířky (exemplář „ad elevationem "
        "poli 49 gr.“ je v moravských historických fondech; <b>Theodosius Rubeus, Tabulae XII</b> "
        "pro 42° udává východ/západ dokonce v „italských“ i „obecných“ hodinách — tedy přesně to "
        "dvojí počítání, jaké potřebuje orloj). Orlojník tedy nejspíš opsal verzi pro <b>výšku "
        "pólu ~50°</b> (Praha). Náš otisk předlohu dále zužuje: je <b>bez refrakce</b> — součet "
        "východů o obou slunovratech je u rukopisu přesně 12:00 (3:55 + 8:05 = 720 min), kdežto "
        "tabulka se zahrnutou refrakcí (−50′, jak by čekal tychonovský zdroj typu Argoliho) by "
        "dala ~707 min (3:48 + 7:58). Předloha tedy patří ke <b>geometrické (starší) tradici</b>, "
        "ne k tychonovským efemeridám. Definitivní ztotožnění by vyžadovalo srovnání číslo po "
        "čísle s digitalizovanou tabulkou pro výšku pólu 50°.</p>"
        "<p><b>Závěr.</b> Tabule východu (a obdobně poledne a západu) Slunce je <b>produktem "
        "výpočtu, ne měření</b>, a do orlojní knihy byla nejspíš <b>opsána z hotové tištěné "
        "tabulky</b> pro pražskou šířku (sekce je datovatelná kolem r. 1641). Vychází ze "
