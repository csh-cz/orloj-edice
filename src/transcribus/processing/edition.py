...
_FOLIO_SNIP: dict[int, str] = {
    ...
    # Táborského Zpráva (kap. I–XVIII): mapováno z Teigeho zarovnání + rukopisných
    # záhlaví kapitol; u neukotvených folií rozsah / „(pokrač.)“.
    ...
    8: "Táborský — rozdělení na XVIII kapitol; kap. I (chvála orloje)",
    9: "Táborský — kap. I: chvála orloje pražského (pokrač.)",
    10: "Táborský — kap. II: čeho orloj a jeho zprávce potřebuje",
    11: "Táborský — kap. III–IV: rozdíl orloje; první a druhá strana",
    12: "Táborský — kap. V–VI: třetí strana; čtvrtá strana (kalendář)",
    13: "Táborský — kap. VI: kalendář a počet hodin (pokrač.)",
    ...
    24: "Táborský — kap. VII–VIII: kola slunce a měsíce",
    25: "Táborský — kap. VIII–IX: kolo sluneční",
    26: "Táborský — kap. IX: kolo sluneční (pokrač.)",
    27: "Táborský — kap. IX–X: hlavní kolo",
    28: "Táborský — kap. X–XI: kolo zvířetníku",
    29: "Táborský — kap. XII: kolo měsíce",
    30: "Táborský — kap. XII–XIII (pokrač.)",
    31: "Táborský — kap. XIII: zpravení pochybení běhu měsíce a slunce",
    32: "Táborský — kap. XIII (pokrač.)",
    33: "Táborský — kap. XIII–XIV (pokrač.)",
    34: "Táborský — kap. XIV: napravení kalendáře s počtem hodin",
    35: "Táborský — kap. XIV–XV (pokrač.)",
    36: "Táborský — kap. XV–XVI: poslední tajnost; počet polouorlojní",
    37: "Táborský — kap. XVI: počet polouorlojní",
    38: "Táborský — kap. XVI–XVII (pokrač.)",
    39: "Táborský — kap. XVII: měnění a neustavičnost orloje",
    40: "Táborský — kap. XVII–XVIII (pokrač.)",
